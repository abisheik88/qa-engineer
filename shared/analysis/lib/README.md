...
│   └── cli.py           `python -m qa_analysis.cli <command>`
...
python3 -m qa_analysis.cli junit <path>
python3 -m qa_analysis.cli har <path> [--slow-ms N]
python3 -m qa_analysis.cli discover [--root DIR] [--path P ...]
python3 -m qa_analysis.cli diff-guard <diff-file>
python3 -m qa_analysis.cli validate <instance.json> <schema.json>
python3 -m qa_analysis.cli classify "<error message>" [--http-status N]
python3 -m qa_analysis.cli redact <file>
python3 -m qa_analysis.cli context [--root DIR] [--path .qa/context.md]
```
